...
//    // ADDED: Serial Version UID to prevent InvalidClassException during session deserialization updates
//    @Serial
//    private static final long serialVersionUID = 1L;
    ...
    public ApplicationUserDetails(final long userId,
        ...
        if (hashedPassword == null || hashedPassword.isBlank()) throw new IllegalArgumentException("Password hash cannot be null or blank");
        if (type == null) throw new NullPointerException("UserType cannot be null");
    ...
    public String afm() { return this.afm; }

    public String amka() { return this.amka; }

    public String firstName() { return this.firstName; }

    public String lastName() { return this.lastName; }

    public UserType type() { return this.type; }

    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() {
        final String role;
        if (this.type == UserType.EMPLOYEE) role = "ROLE_EMPLOYEE";
        else if (this.type == UserType.CITIZEN) role = "ROLE_CITIZEN";
        else if (this.type == UserType.ADMIN) role = "ROLE_ADMIN";
